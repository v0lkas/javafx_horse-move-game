...
public class Menu extends Application {
    ...
    public String thema() {
        ...
        alert.setTitle("Horse move game");
        alert.setHeaderText("What do you like the most?");
        alert.setContentText("Choose your thematics:");

        ButtonType animals = new ButtonType("Animals");
        ButtonType nature = new ButtonType("Nature");
        ButtonType cars = new ButtonType("Cars");
        ButtonType sport = new ButtonType("Sport");
        ButtonType girls = new ButtonType("Girls");
        ButtonType men = new ButtonType("Men");
        ButtonType city = new ButtonType("City");

        alert.getButtonTypes().setAll(animals,nature,cars,sport,girls,men,city);

        Optional<ButtonType> result = alert.showAndWait();

        if (result.get() == animals) {
            thematics = "animals";
        } else if (result.get() == nature) {
            thematics = "nature";
        } else if (result.get() == cars) {
            thematics = "cars";
        } else if (result.get() == sport) {
            thematics = "sport";
        } else if (result.get() == girls) {
            thematics = "girls";
        } else if (result.get() == men) {
            thematics = "men";
        } else if (result.get() == city) {
            thematics = "city";
        }
        ...
        if(thematics != "") {
            ...
            btn5.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent event) {
                    ...
                    stage.close();
                    try {
                        new PlayGame(value0, 5, 5,thematics);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
            ...
            btn10.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent event) {
                    ...
                    stage.close();
                    try {
                        new PlayGame(value0, 10, 10,thematics);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
            ...
            btn15.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent event) {
                    ...
                    stage.close();
                    try {
                        new PlayGame(value0, 15, 15,thematics);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
                ...
                public void handle(ActionEvent event) {
                    ...
                    try {
                        ...
                        if (value1 >= minHorizontal && value1 <= maxHorizontal && value2 >= minVertical && value2 <= maxVertical) {
                            stage.close();
                            new PlayGame(value0, value1, value2,thematics);
                        } else {
